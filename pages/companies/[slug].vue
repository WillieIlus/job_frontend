                  ...
                  <nav class="inline-block" aria-label="breadcrumb text-center">
                    <ol class="flex justify-center text-sm font-medium uppercase">
                      ...
                      <li class="active" aria-current="page"><i
                          class="bx bxs-chevron-right align-middle px-2.5"></i>Company Details</li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div class="grid grid-cols-12 gap-y-10 lg:gap-10">
            <div class="col-span-12 lg:col-span-4">
              <div class="border rounded border-gray-100/50 dark:border-neutral-600">
                  ...
                  <ul class="space-y-4">
                    <li>
                      <div class="flex flex-wrap">
                        ...
                        <div>
                          <p class="mb-0 text-gray-500 dark:text-gray-300">Charles Dickens</p>
                        </div>
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      <div class="flex flex-wrap">
                        ...
                        <div>
                          <p class="mb-0 text-gray-500 dark:text-gray-300">New York</p>
                        </div>
                      </div>
                    </li>
                    <li>
                ...
                <div class="p-5 border-b border-gray-100/50 dark:border-neutral-600">
                  <h6 class="mb-3 font-semibold text-gray-900 text-17 dark:text-gray-50">Working Days</h6>
                  <div>
                    <ul class="space-y-3 text-gray-900">
                      <li class="text-gray-900 dark:text-gray-50">Monday<span
                          class="text-gray-500 ltr:float-right rtl:float-left text-13 dark:text-gray-300">9AM - 5PM</span>
                      </li>
                      <li class="text-gray-900 dark:text-gray-50">Tuesday<span
                          class="text-gray-500 ltr:float-right rtl:float-left text-13 dark:text-gray-300">9AM - 5PM</span>
                      </li>
                      <li class="text-gray-900 dark:text-gray-50">Wednesday<span
                          class="text-gray-500 ltr:float-right rtl:float-left text-13 dark:text-gray-300">9AM - 5PM</span>
                      </li>
                      <li class="text-gray-900 dark:text-gray-50">Thursday<span
                          class="text-gray-500 ltr:float-right rtl:float-left text-13 dark:text-gray-300">9AM - 5PM</span>
                      </li>
                      <li class="text-gray-900 dark:text-gray-50">Friday<span
                          class="text-gray-500 ltr:float-right rtl:float-left text-13 dark:text-gray-300">9AM - 5PM</span>
                      </li>
                      <li class="text-gray-900 dark:text-gray-50">Saturday<span
                          class="text-gray-500 ltr:float-right rtl:float-left text-13 dark:text-gray-300">9AM - 5PM</span>
                      </li>
                      <li class="text-gray-900 dark:text-gray-50">Sunday<span
                          class="text-red-600 ltr:float-right rtl:float-left text-13" dark:text-gray-300>Close</span></li>
                    </ul>
                  </div>
                </div>
                <div class="p-5">
            ...
            <div class="col-span-12 lg:col-span-8">
              <div class="p-6 border rounded border-gray-100/50 dark:border-neutral-600">
                <div>
                  ...
                  <p class="mb-4 text-gray-500 dark:text-gray-300">Objectively pursue diverse catalysts for change for
                    interoperable meta-services. Distinctively re-engineer revolutionary meta-services and premium
                    architectures. Intrinsically incubate intuitive opportunities and real-time potentialities.
                    Appropriately communicate one-to-one technology.</p>

                  <p class="mb-4 text-gray-500 dark:text-gray-300">Intrinsically incubate intuitive opportunities and
                    real-time potentialities Appropriately communicate one-to-one technology.</p>

                  <p class="text-gray-500 dark:text-gray-300">Exercitation photo booth stumptown tote bag Banksy, elit
                    small batch freegan sed. Craft beer elit seitan exercitation, photo booth et 8-bit kale chips proident
                    chillwave deep v laborum. Aliquip veniam delectus, Marfa eiusmod Pinterest in do umami readymade swag.
                  </p>
                </div>
                <div class="pt-8">
                ...
                <div class="pt-10">
                  ...
                  <div class="mt-5 space-y-5">
                      ...
                      <div class="p-6">
                        <div class="grid grid-cols-12 gap-y-5 lg:gap-5">
                          ...
                          <div class="col-span-10">
                            <h5 class="mb-1 fs-17"><a href="job-details.html" class="text-gray-900 dark:text-gray-50">HTML
                                Developer</a>
                            ...
                            <ul class="flex flex-wrap gap-3 mb-0">
                              ...
                              <li>
                                <p class="mb-0 text-sm text-gray-500 dark:text-gray-300"><i
                                    class="mdi mdi-map-marker"></i> California</p>
                              </li>
                              <li>
                                <p class="mb-0 text-sm text-gray-500 dark:text-gray-300"><i
                                    class="uil uil-wallet ltr:mr-2 rtl:ml-2"></i> $250 - $800 / month</p>
                              </li>
                            </ul>
                            <div class="mt-4">
                              <div class="flex flex-wrap gap-1.5">
                                <span
                                  class="badge bg-green-500/20 text-green-500 text-11 px-2 py-0.5 font-medium rounded">Full
                                  Time</span>
                                <span
                                  class="badge bg-yellow-500/20 text-yellow-500 text-11 px-2 py-0.5 font-medium rounded">Urgent</span>
                                <span
                                  class="badge bg-sky-500/20 text-sky-500 text-11 px-2 py-0.5 font-medium rounded">Private</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-12 gap-y-5 lg:gap-5">
                          ...
                          <div class="col-span-10">
                            <h5 class="mb-1 fs-17"><a href="job-details.html"
                                class="text-gray-900 dark:text-gray-50">Marketing Director</a>
                            ...
                            <div class="mt-4">
                              <div class="flex flex-wrap gap-1.5">
                                <span
                                  class="badge bg-red-500/20 text-red-500 text-11 px-2 py-0.5 font-medium rounded">Part
                                  Time</span>
                                <span
                                  class="badge bg-sky-500/20 text-sky-500 text-11 px-2 py-0.5 font-medium rounded">Private</span>
                              </div>
                      ...
                      <div class="absolute top-4 ltr:right-4 rtl:left-4">
                        <div
                          class="w-8 h-8 text-center text-gray-100 transition-all duration-300 bg-transparent border rounded border-gray-100/50 hover:bg-red-600 hover:border-transparent hover:text-white dark:border-zinc-700">
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <div class="grid grid-cols-12 gap-y-5 lg:gap-5">
                          ...
                          <div class="col-span-10">
                            <h5 class="mb-1 fs-17"><a href="job-details.html"
                                class="text-gray-900 dark:text-gray-50">Product Designer</a>
                            ...
                            <div class="mt-4">
                              <div class="flex flex-wrap gap-1.5">
                                <span
                                  class="badge bg-sky-500/20 text-sky-500 text-11 px-2 py-0.5 font-medium rounded">Internship</span>
                              </div>
                            </div>
                          </div>
                        </div>
