                    ...
                    <div class="grid grid-cols-12 gap-5">
                      <div class="col-span-12 lg:col-span-1">
                        <div class="px-2 mb-4 text-center mb-md-0">
                          <a href="company-details.html"><img src="" alt=""
                ...
                <div
                  ...
                  <div class="p-6">
                    <div class="grid grid-cols-12 gap-5">
                      ...
                      <!--end col-->
                      <div class="col-span-10">
                        <h5 class="mb-1 fs-17"><a href="job-details.html" class="dark:text-gray-50">Product Sales
                            Specialist</a>
                  ...
                  <div class="p-6">
                    <div class="grid grid-cols-12 gap-5">
                      ...
                      <div class="col-span-10">
                        ...
                        <div class="mt-4">
                          <div class="flex flex-wrap gap-1.5">
                            <span class="bg-sky-500/20 text-sky-500 text-11 px-2 py-0.5 font-medium rounded">
                              Internship</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-span-10">
                        ...
                        <div class="mt-4">
                          <div class="flex flex-wrap gap-1.5">
                            <span class="bg-green-500/20 text-green-500 text-11 px-2 py-0.5 font-medium rounded"> Full
                              Time</span>
                            <span class="bg-yellow-500/20 text-yellow-500 text-11 px-2 py-0.5 font-medium rounded">
                              Urgent</span>
                            <span class="bg-sky-500/20 text-sky-500 text-11 px-2 py-0.5 font-medium rounded">
                              Private</span>
                          </div>
                  ...
                  <div class="p-6">
                    <div class="grid grid-cols-12 gap-5">
                      ...
                      <div class="col-span-10">
                        ...
                        <div class="mt-4">
                          <div class="flex flex-wrap gap-1.5">
                            <span class="bg-violet-500/20 text-violet-500 text-11 px-2 py-0.5 font-medium rounded">
                              Freelance</span>
                            <span class="bg-yellow-500/20 text-yellow-500 text-11 px-2 py-0.5 font-medium rounded">
                              Urgent</span>
                            <span class="bg-sky-500/20 text-sky-500 text-11 px-2 py-0.5 font-medium rounded">
